      ...
      <div className="container mx-auto flex h-28 lg:h-32 items-center justify-between px-4 lg:px-6">
        <a href="#" onClick={scrollToTop} className="flex items-center cursor-pointer group">
          ...
          <Image
            ...
            width={500}
            height={150}
            className={`h-20 sm:h-24 lg:h-28 w-auto object-contain transition-all duration-300 group-hover:opacity-85 ${scrolledStyles ? "scale-90" : "scale-100"} ${logoLoaded ? "opacity-100" : "opacity-0"}`}
            priority
            quality={100}
