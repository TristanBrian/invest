        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="mx-auto max-w-5xl overflow-hidden border border-amber-200 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 mb-12 bg-white">
            <div className="grid gap-0 md:grid-cols-5 md:gap-12">
              {/* Image Section - FIXED */}
              <div className="md:col-span-2">
                <div className="relative w-full h-[400px] md:h-[500px] overflow-hidden bg-slate-100">
                ...
                {/* Credential Badge - FIXED */}
                <div className="mt-[-40px] mx-4">
                  <div className="bg-gradient-to-r from-amber-900 to-amber-800 p-4 text-white rounded-lg shadow-lg">
